...
public class BeanContextServicesSupport extends BeanContextSupport implements BeanContextServices, Serializable {
	 ...
	 * </p>
	 * 
	 * @see BeanContextServices#addService(Class,
	 ...
	 * </p>
	 * 
	 * @see BeanContextSupport#bcsPreDeserializationHook(ObjectInputStream)
	 */
	 ...
	 * </p>
	 * 
	 * @see BeanContextSupport#bcsPreSerializationHook(ObjectOutputStream)
	 */
	protected void bcsPreSerializationHook(ObjectOutputStream oos) throws IOException {
		...
		synchronized (services) {
			...
			for (Iterator<Entry<Class<?>, BCSSServiceProvider>> iter = services.entrySet().iterator(); iter.hasNext();) {
				Entry<Class<?>, BCSSServiceProvider> entry = iter.next();
	 ...
	 * </p>
	 * 
	 * @see BeanContextSupport#childJustRemovedHook(Object,
	 *      BCSChild)
	 */
	 ...
	 * 
	 * @see BeanContextSupport#createBCSChild(Object,
	 *      Object)
	 */
	 ...
	 * 
	 * @see BeanContextServices#getCurrentServiceSelectors(Class)
	 */
	 ...
	 * @see BeanContextServices#hasService(Class)
	 */
	 ...
	 * @see BeanContextServices#revokeService(Class,
	 *      BeanContextServiceProvider,
	 *      boolean)
	 */
